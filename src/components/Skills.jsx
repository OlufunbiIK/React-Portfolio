...
//               <div className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500/10 to-purple-600/10 rounded-full border border-blue-500/20">
...
//                   : "bg-white/50 text-gray-700 hover:bg-gray-100/50 border border-gray-200/50"
//               } backdrop-blur-sm`}
//             >
//               All Skills
//             </button>
...
//                     darkMode
//                       ? "bg-gray-900/60 border border-gray-800/50 hover:border-gray-700/80"
//                       : "bg-white/60 border border-white/50 hover:border-gray-200/80"
...
//                     <h3
//                       className={`text-2xl font-bold mb-2 group-hover:bg-gradient-to-r group-hover:${
//                         skill.color
